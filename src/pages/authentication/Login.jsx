...
import travel from "../../assets/images/travel-2.png";
...
function Login() {
  ...
  return (
    <section className="h-screen overflow-auto duration-300">
      <div className="py-6 bg-green text-white text-center flex items-center justify-center gap-3 ">
        <svg
        ...
        <h2 className="text-2xl">Travalizer</h2>
      </div>
      <div className="h-[calc(100%-96px)] flex items-center justify-center my-10 lg:my-0">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-0  max-w-5xl mx-auto lg:rounded-xl lg:shadow-lg overflow-hidden duration-300">
          <div className="p-6 lg:bg-mist flex items-center justify-center">
            <img src={travel} alt="" className="w-full max-w-sm mx-auto" />
          </div>
          <form
            action="#"
            onSubmit={handleSubmit}
            className="p-6 flex flex-col gap-4 w-full max-w-lg mx-auto lg:bg-white lg:py-10"
          >
            <div>
              <h2 className="text-2xl font-bold">Welcome Back</h2>
              <p className="text-base text-fade mt-1">
            ...
            <div className="flex flex-col gap-2 mt-2">
              ...
              <input
                type="text"
                name="email"
                className="w-full bg-transparent border border-fadeLigh p-3 rounded-lg outline-none text-sm"
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-1">
                <input type="checkbox" className="bg-green" id="remember" />
            ...
            <div className="mt-6">
              <button
                type="submit"
                className="py-3 px-10 rounded-lg bg-green text-white"
                disabled={isLoading}
              >
                Login
              </button>
      ...
      <ToastContainer
        ...
        theme="light"
      />
      {/* <Toast type="error" title="Something went wrong!"></Toast> */}
    </section>
  );
}
